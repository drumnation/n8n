# Brain Monitor - Development Rules
...
2. [Cm Proxy Rules](#cm-proxy-rules)
3. [Monorepo Documentation Strategy](#monorepo-documentation-strategy)
4. [Monorepo Node Express Architecture](#monorepo-node-express-architecture)
...
7. [Project Wide Proxy Rules](#project-wide-proxy-rules)
8. [Tests.continuous Validation](#tests.continuous-validation)
...
> **When to apply:** Content Manager API proxy rules and patterns
...
> **When to apply:** Project-wide API proxy patterns and middleware configuration
